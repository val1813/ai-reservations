...
The classical gravitational results of this paper (Secs.~\ref{sec:dynamics}--\ref{sec:selforg}) are \emph{independent} of it---they require only A1, A2, and the Tier~2 structural choices enumerated in Table~\ref{tab:tiers}.
...
\begin{enumerate}
    ...
    Their connection to quantum mechanics relies on Zilly's (2026) theorem as an external input, not on A1--A2 alone.
