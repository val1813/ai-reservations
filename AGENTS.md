...
- INSPECTOR, REVIEWER, AUDITOR, and A/B roles must be launched as independent agent instances when the SOP requires them. The PI/main context must not hand-write those reports.
